  ...
  return(
     ...
     <div className="bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass">
      ...
      <div className="flex justify-between mb-6">
        ...
        rounded-full text-medium-grey text-sm font-bold" onClick={()=> handleMudarNotaAvaliacao(1)}/>
        <input type="button"value={2}className="bg-dark-blue w-10.5 h-10.5 
        rounded-full text-medium-grey text-sm font-bold"onClick={()=> handleMudarNotaAvaliacao(2)}/> 
        <input type="button"value={3}className="bg-dark-blue w-10.5 h-10.5 
        rounded-full text-medium-grey text-sm font-bold"onClick={()=> handleMudarNotaAvaliacao(3)}/> 
        <input type="button"value={4}className="bg-dark-blue w-10.5 h-10.5 
        rounded-full text-medium-grey text-sm font-bold"onClick={()=> handleMudarNotaAvaliacao(4)}/> 
        <input type="button"value={5} className="bg-dark-blue w-10.5 h-10.5 
        rounded-full text-medium-grey text-sm font-bold"onClick={()=> handleMudarNotaAvaliacao(5)}/>
      </div>

      <button className="bg-orange w-full uppercase tracking-1 font-bold rounded-3xl 
